...
public class RentalStoreBK {
    ...
    public static void loadRental(String datafile) {
        try {
            ...
            Logger.getLogger(RentalStoreBK.class.getName()).log(Level.INFO, "Loaded {0} from file {1}", new Object[]{data.name, datafile});
        } catch (NumberFormatException ex) {
            Logger.getLogger(RentalStoreBK.class.getName()).log(Level.SEVERE, "bad file", ex);
        } catch (IOException ex) {
            Logger.getLogger(RentalStoreBK.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static CrcData loadData(String datafile)
        ...
        //open file from jar
        BufferedReader in = new BufferedReader(new InputStreamReader(RentalStoreBK.class.getClassLoader().getResourceAsStream(datafile)));
